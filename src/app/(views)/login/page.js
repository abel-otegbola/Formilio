                ...
                <div className="py-[30px] grid md:grid-cols-2 grid-cols-1 gap-2">
                    {
                        [{key: 1, id: "google", name: "Google"}, {key: 2, id: "github", name: "Github"}].map((provider) => ( 
                            <a onClick={() => signIn(provider.id, {callbackUrl: `${window.location.origin}/dashboard`})} className="flex items-center justify-center bg-white dark:bg-gray-900 cursor-pointer p-4 my-2 rounded border border-gray-400">
