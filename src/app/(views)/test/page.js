...
export default function Login() {
    ...
    return (
        <div className="md:px-[10%] px-[5%] py-[5%] dark:bg-gray-900">
            <form action={`https://mailme.vercel.app/api/endpoint/${query}`} method="post" className="p-[20px] md:px-[40px] bg-slate-100 dark:bg-gray-800 rounded md:w-[500px] w-full m-auto">
