...
export default function Topbar() {
    ...
    return (
        <>    
        <div className="fixed w-full flex shadow-md font-body justify-between items-center p-2 md:py-2 py-3 md:px-[10%] px-[5%] md:pr-[13%] pr-[10%] backdrop-blur-sm bg-white/[0.7] dark:bg-gray-900/[0.7] border border-slate-50/[0.1] border-b-gray-100 dark:border-b-gray-200/[0.1] z-10">
            ...
            <div className={`fixed md:top-[3%] top-[3.7%] ml-4 text-gray-500 text-2xl transition-all duration-700 z-50 ${open ? "md:right-[3%] right-[3%]": " md:right-[10%] right-[5%]"}`} onClick={() =>  setOpen(!open) }>
                {
                    open ? <FaTimes /> : <FaBars />
                }
            </div>
            <div className="absolute top-0 right-0 h-screen z-20">
