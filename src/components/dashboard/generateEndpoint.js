...
export default function GenerateEndpoint() {
    ...
    return (
        <div>
            ...
            <div className="md:flex md:w-[70%] mb-2 gap-2 rounded-lg w-full align-center">
                ...
                <button className="flex items-center justify-center p-[12px] px-6 rounded bg-blue text-white md:w-auto w-full hover:bg-hoverblue" onClick={() => createEndpoint()}>{loading ? <CgSpinner className="animate-spin mr-2 text-2xl" /> : ""} Generate new endpoint</button>
            </div>
        </div>
    )
}